  ...
  addAgent() {
    return (
      <>
        <EuiFlexGroup >
          <EuiFlexItem >
            <EuiCallOut title={<>Không agent nào được thêm vào để quản lý.  <EuiButtonEmpty href='#/agents-preview?'>Add agent</EuiButtonEmpty></>} color="warning" iconType="alert">
            </EuiCallOut>
          </EuiFlexItem >
        </EuiFlexGroup>
        <EuiSpacer size="xl" />
        ...
        <EuiPage className="wz-welcome-page">
          <EuiFlexGroup>
            <EuiFlexItem>
              ...
              <EuiFlexGroup>
                <EuiFlexItem>
                  <EuiCard title description betaBadgeLabel="Quản lý thông tin an ninh">
                    <EuiSpacer size="s" />
