...
const checks = {
  api: {
    title: 'Kiểm tra kết nối API Wazuh',
    label: 'Kết nối API',
  ...
  setup: {
    title: 'Kiểm tra phiên bản API Wazuh',
    label: 'Phiên bản API',
    validator: checkSetupService,
    awaitFor: ["api"],
  },
  pattern: {
    title: 'Kiểm tra mẫu chỉ mục cảnh báo',
    label: 'Mẫu chỉ mục cảnh báo',
  ...
  patternMonitoring: {
    title: 'Kiểm tra mẫu chỉ số giám sát',
    label: 'Giám sát mẫu chỉ số',
  ...
  patternStatistics: {
    title: 'Kiểm tra mẫu chỉ số thống kê',
    label: 'Mẫu chỉ số thống kê',
